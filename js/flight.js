        ...
        //   .then((data) => {
            ...
            data.forEach(function (ticket) {
              ...
              reserveButton.addEventListener("click", function () {
                ...
                newWindow2.document.write("console.log(data);");

                // comment

                // newWindow2.document.write(`fetch('/-django-endpoint', {
                //   method: 'POST',
                //   headers: {
              ...
              weightAllowedElement.textContent =
                "Weight Allowed: " + ticket.weightAllowed;
